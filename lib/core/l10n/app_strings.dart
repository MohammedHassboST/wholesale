...
const Map<String, String> _en = {
  ...
  'انتهى العرض ⚠️': 'Offer ended ⚠️',
  'انتهى العرض — متاح بالسعر الأصلي': 'Offer ended — Available at original price',
  'بالسعر الأصلي (انتهى العرض)': 'Original price (offer ended)',
  'في السلة ({q})': 'In cart ({q})',
  'في السلة ({q}) - الحد الأقصى': 'In cart ({q}) - Max reached',
  'تم حجز كل الكمية المتاحة بالسلة!': 'All available stock reserved in cart!',
  ...
  // ---- minimum purchase & offer conditions ----
  'الحد الأدنى لطلب المتجر المجمع': 'Store combined min order',
  'محدد بـ: {m} لكافة الأصناف والعروض معاً': 'Set to: {m} for all items & offers combined',
  'غير محدد (أي قيمة مقبولة)': 'Not set (any value accepted)',
  'تحديد الحد الأدنى لقيمة الشراء الإجمالية من متجرك (كافة الأصناف والعروض معاً) لتأكيد أي طلب.':
      'Set the minimum combined purchase value from your store (all products & offers combined) to confirm any order.',
  'الحد الأدنى لكمية الطلب': 'Min order qty',
  'شروط الاستفادة من العرض (اختياري)': 'Offer qualification conditions (optional)',
  'الحد الأدنى للشراء: {val}': 'Min purchase: {val}',
  'الحد الأدنى لقيمة الشراء (ج.م)': 'Min purchase value (EGP)',
  'الحد الأدنى لقيمة الشراء من هذا الصنف (ج.م)': 'Min purchase value for this product (EGP)',
  'الحد الأدنى للشراء: {val} ج.م': 'Min purchase: {val} EGP',
  'الحد الأدنى لطلب المورد: {val}': 'Vendor min order: {val}',
  'الحد الأدنى لطلب المتجر: {val}': 'Store min order: {val}',
  'الحد الأدنى لطلبات هذا المتجر: {val} ج.م': 'Store min order: {val} EGP',
  'إعدادات الحد الأدنى لطلبات المتجر': 'Store minimum order settings',
  'تحديد الحد الأدنى لطلبات متجرك (ج.م)': 'Set your store minimum order (EGP)',
  'القيمة المجمعة لكافة الأصناف والعروض معاً': 'Combined value for all products & offers',
  'الحد الأدنى لطلب المتجر (ج.م)': 'Store min order (EGP)',
  'تم تحديث الحد الأدنى للمتجر بنجاح': 'Store min order updated successfully',
  'يتبقى {d} للحد الأدنى للمنتج!': '{d} left for product minimum!',
  'يتبقى {d} للحد الأدنى لطلب المورد!': '{d} left for vendor order minimum!',
  'لم يستوفِ الحد الأدنى للشراء': 'Minimum purchase not met',
  'الحد الأدنى لكمية العرض:': 'Offer min quantity:',
  'أدنى كمية لتفعيل العرض': 'Min qty to unlock offer',
  'أدنى قيمة لطلب المورد لتفعيل العرض (ج.م)': 'Min vendor order to unlock offer (EGP)',
  'شرط العرض: شراء {q} {u} فأكثر': 'Offer condition: buy {q} {u} or more',
  'شرط العرض: طلب بقيمة {v} من المورد': 'Offer condition: order {v} from vendor',
  'شرط العرض: {q} {u} + طلب {v}': 'Offer condition: {q} {u} + {v} order',
  'مؤهل لسعر العرض 🎉': 'Qualified for offer price 🎉',
  'غير مؤهل لسعر العرض (شروط غير مكتملة)': 'Not qualified for offer price (conditions not met)',
  'سعر العرض يتطلب شراء {q} {u}': 'Offer price requires buying {q} {u}',
  'سعر العرض يتطلب طلب بقيمة {v} من المورد': 'Offer price requires {v} order from vendor',
  'الحد الأدنى لقيمة الشراء: {val}': 'Min purchase value: {val}',
  'الحد الأدنى لشراء هذا الصنف هو {val}': 'Min purchase for this item is {val}',
  // ---- order items display ----
  'الأصناف المطلوبة': 'Ordered items',
  'الأصناف المطلوب تجهيزها': 'Items to prepare',
  'الأصناف المطلوب تجهيزها ({n})': 'Items to prepare ({n})',
  'الأصناف ({n})': 'Items ({n})',
  'سعر الوحدة: {p}': 'Unit price: {p}',
  'الكمية: {q} {u}': 'Qty: {q} {u}',
  'إجمالي الصنف: {t}': 'Item total: {t}',
  'جاري تحميل أصناف الطلب...': 'Loading order items...',
  'تفاصيل الأصناف غير متوفرة': 'Item details unavailable',
  'إجمالي التوفير: {s}': 'Total savings: {s}',
  'سعر عرض مخفض': 'Discounted offer price',
  // ---- realtime live status ----
  'متصل لحظياً بالمنصة (مزامنة فورية)': 'Live synced with platform',
  'جارٍ الاتصال والمزامنة اللحظية...': 'Connecting & syncing live...',
  'غير متصل بالخادم — انقطاع الاتصال': 'Server offline — Connection lost',
